...
Private Function showNumBtn()
 ...
 str_tmp=str_tmp & "<a href=""" & XD_sURL & CStr(pre_page) & """><<</a> "
 For i=1 to Max_page
 if i>int_totalpage then exit for
  ...
  str_tmp=str_tmp & "[<a href=""" & XD_sURL & CStr(i+Max_page) & """>"&i+Max_page&"</a>] "
  end if
  else
 ...
 Next
  str_tmp=str_tmp & "<a href=""" & XD_sURL & CStr(next_page) & """>>></a> "
 showNumBtn=str_tmp
End Function
