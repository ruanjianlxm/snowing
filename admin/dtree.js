...
function checkupdate(InputUrl,OutMessage)
{
	try {
	...
	xmlhttp.onreadystatechange=function(){
		if (xmlhttp.readyState==4)
		{
			...
			{
			document.getElementById(OutMessage).innerHTML=xmlhttp.responseText;
			}
		}
	}
	xmlhttp.open("post",InputUrl,true);
	xmlhttp.setRequestHeader('Content-type','application/x-www-form-urlencoded');
	xmlhttp.send(true);	
	} catch(e) {
	document.getElementById(OutMessage).innerHTML="数据获取失败，可能升级地址已更新。";
	}
}